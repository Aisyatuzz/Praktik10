...
$india = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='India'");
$japan = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Japan'");
$korea = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='S.Korea'");
$turkey = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Turkey'");
$viet = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Vietnam'");
$taiwan = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Taiwan'");
$iran = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Iran'");
$indo = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Indonesia'");
$malay = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Malaysia'");
$israel = mysqli_query($conn, "SELECT * FROM covid_data WHERE country='Israel'");
?>
...
<body>
    ...
    <center><h2>GRAFIK LINE COVID-19</h2></center>
    <br>
    <div class="container">
...
var data = {
            labels: ["total_cases","total_deaths","total_recovered","active_cases","total_tests"],
            datasets: [
                {
                    label: "India",
                    fill: false,
                ...
                },
                {
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($korea)) { echo '"' . $p['total_cases'] . '","' . $p['total_deaths'] . '","' . $p['total_recovered'] . '","' . $p['active_cases'] . '","' . $p['total_tests'] . '",';}?>]
                },
                {
                    label: "Turkey",
                    fill: false,
                ...
                },
                {
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($viet)) { echo '"' . $p['total_cases'] . '","' . $p['total_deaths'] . '","' . $p['total_recovered'] . '","' . $p['active_cases'] . '","' . $p['total_tests'] . '",';}?>]
                },
                {
                    label: "Taiwan",
                    fill: false,
